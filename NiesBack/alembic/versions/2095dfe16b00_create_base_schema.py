...
Revision ID: 2095dfe16b00
Revises: 
Create Date: 2025-11-04 14:17:08.256485
...
def upgrade() -> None:
    ...
    sa.Column('powerbi_url', sa.String(length=1000), nullable=True),
    ...
    op.create_table('report_access_levels',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('report_id', sa.String(length=64), nullable=False),
    sa.Column('level', sa.Enum('gestao', 'estrategico', 'operacional', 'outros', name='accesslevel'), nullable=False),
    sa.ForeignKeyConstraint(['report_id'], ['reports.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('report_id', 'level', name='uq_report_level')
    )
    op.create_index(op.f('ix_report_access_levels_report_id'), 'report_access_levels', ['report_id'], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_report_access_levels_report_id'), table_name='report_access_levels')
    op.drop_table('report_access_levels')
